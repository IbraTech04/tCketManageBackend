 ...
 * host's component scan (a host such as the Minbar/LensBridge backend scans its own base package,
 * not ours). Instead this auto-configuration discovers and registers every core bean itself:
 * <ul>
